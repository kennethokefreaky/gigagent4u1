  ...
  return (
    <div className="bg-background px-4 py-4">
      <div className="flex items-center space-x-3">
        {/* Profile Picture */}
        <div className="w-10 h-10 rounded-full bg-input-background flex items-center justify-center">
        ...
        {/* Search Bar */}
        <div 
          className="flex-1 bg-input-background rounded-lg px-4 py-3 flex items-center space-x-3 cursor-pointer hover:bg-surface transition-colors"
        ...
        >
          ...
          <span className="text-text-secondary">
            {userType === "promoter" ? "Invite Talent" : "Search Location"}
          </span>
        </div>
        ...
        <button 
          ...
          className={`p-2 transition-colors ${
            hasActiveFilters 
              ? "text-button-red hover:text-button-red-hover" 
      ...
      {/* Location Search Bottomsheet for Talent Users */}
      {showLocationSearch && (
        <>
          {/* Google Maps Script */}
          <Script
          ...
          >
            <div className="w-full bg-background rounded-t-2xl p-6 bottom-sheet overflow-y-auto max-h-[80vh]">
