...
export const saveUserLocation = async (
  ...
  try {
    console.log('🔍 Saving user location:', { userId, locationData });
    ...
    console.log('✅ User location saved successfully:', data);
    return data;
  } catch (error) {
    console.error('❌ Exception in saveUserLocation:', error);
    return null;
  }
};
