-- FIX UNIFIED MESSAGING FUNCTIONS
-- This script creates only the missing database functions
...
-- 1. CREATE/UPDATE get_unified_messages FUNCTION
...
-- 2. CREATE/UPDATE send_unified_message FUNCTION
