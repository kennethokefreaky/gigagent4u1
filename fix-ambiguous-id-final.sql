-- FIX AMBIGUOUS ID ERROR - FINAL VERSION
-- This script fixes the remaining ambiguous id reference
...
DECLARE
  ...
  sender_avatar TEXT;
BEGIN
  -- Check if sender is a participant with explicit table alias
  IF NOT EXISTS (
  ...
  -- Get sender info with explicit table reference
  SELECT 
